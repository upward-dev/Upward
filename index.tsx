      ...
      <section className="d-flex flex-column w-sm-100 w-50 justify-content-start align-items-center">
        ...
        <div className="card">
          <div className="card-header" role="tab" id="headingOne">
            <h5 className="mb-0">
              <a className="collapsed" onClick={() => setShowProject(!showProject)} data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                Add Projects
              </a>
            </h5>
          </div>
          <div id="collapseOne" className={`collapse ${showProject && "show"}`} role="tabpanel" aria-labelledby="headingOne">
        ...
        <div className="card">
          <div className="card-header" role="tab" id="headingTwo">
            <h5 className="mb-0">
              <a className="collapsed" onClick={() => setShowExperience(!showExperience)} data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                Add Experiences
              </a>
            </h5>
          </div>
          <div id="collapseTwo" className={`collapse ${showExperience && "show"}`} role="tabpanel" aria-labelledby="headingTwo">
